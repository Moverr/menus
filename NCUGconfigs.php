...
//    const PIN_SERVICE_ID = 206;
	...
	const BANK_SIGNATURE = "NC BANK UGANDA";
...
//   const GOTV_PACKAGES = "GOtv Lite=9500, Mobile Bouquet=11250, Lite Quarterly=22000, GOtv Plus=26000, Max Bouquet=49000, Lite 12mths=60000";
	const GOTV_PACKAGES = "GOtv Lite 1=11000, GOtv Value=16000, GOtv Lite 3=25000, GOtv Plus=28000, GOtv Max=49000, GOtv Lite 12=70000";
...
//const ZUKU_PACKAGES = "Smart=10500, Classic=23500, Premium=33500";
	const ZUKU_PACKAGES = "Smart=12000, Classic=26500, Premium=36500";
	const KWESE_PACKAGES = "3 days=17000, 7 days=32000, 30 days=106000";

	const DSTV_SERVICE_ID = 83;
	const DSTV_SERVICE_CODE = "DSTV";
	const DSTVUG_CODE = "DSTV";
	const DSTV_WALLET_MERCHANT_CODE = "DSTV_UGANDA";
	const STARTIMES_SERVICE_ID = 85;
	const STARTIMES_SERVICE_CODE = "STARTIMES";
	const STARTIMES_CODE = "STARTIMES";
	const STARTIMES_WALLET_MERCHANT_CODE = "STARTIMESUG";
	const ZUKU_SERVICE_ID = 86;
	const ZUKU_SERVICE_CODE = "ZUKU";
	const ZUKU_CODE = "ZUKU";
	const ZUKU_WALLET_MERCHANT_CODE = "ZUKUTV";
	const GOTV_SERVICE_ID = 84;
	const GOTV_SERVICE_CODE = "GOTV";
	const GOTV_CODE = "GOTV";
	const GOTV_WALLET_MERCHANT_CODE = "GotvUG";
	const AZAM_SERVICE_ID = 76;
	const AZAM_SERVICE_CODE = "AZAMTV";
	const AZAM_CODE = "AZAMTV";
	const AZAM_WALLET_MERCHANT_CODE = "AZAMTV";
	const KWESE_SERVICE_ID = 77;
